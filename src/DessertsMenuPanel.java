...
class DessertsMenuPanel extends BackgroundPanel {
    public DessertsMenuPanel() {
        ...
        JPanel dessertsPanel = new JPanel(new GridLayout(0, 3, 20, 20)); // 3 columns
    ...
    private void addMenuItem(JPanel panel, String name, String imagePath, double price) {
        ...
        itemPanel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(102, 51, 0), 2), // Brown border
        ...
        imageLabel.setIcon(resizeImageIcon(imagePath, 300, 250));
        imageLabel.setHorizontalAlignment(SwingConstants.CENTER);
        itemPanel.add(imageLabel, BorderLayout.CENTER);

        // Coffee Name and Price
        String styledText = String.format(
                "<html><span style='color:rgb(51,25,0);font-weight:bold;'>%s</span> - <span style='color:rgb(34,139,34);font-weight:bold;'>$%.2f</span></html>",
                name, price
        );
        JLabel nameLabel = new JLabel(styledText, JLabel.CENTER);
        nameLabel.setFont(new Font("Arial", Font.BOLD, 16)); // Apply bold font to the entire label
